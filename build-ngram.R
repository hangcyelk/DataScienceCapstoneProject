...
setwd("C:/Users/hangc/OneDrive/Documents/R/Data Science Capstone Project Milestone Report")
...
blogs_filename <- "./Coursera-SwiftKey/final/en_US/en_US.blogs.txt"
blogs <- readLines(blogs_filename, encoding = "UTF-8", skipNul = TRUE, warn = FALSE)

news_filename <- "./Coursera-SwiftKey/final/en_US/en_US.news.txt"
news <- readLines(news_filename, encoding = "UTF-8", skipNul = TRUE, warn = FALSE)

twitter_filename <- "./Coursera-SwiftKey/final/en_US/en_US.twitter.txt"
